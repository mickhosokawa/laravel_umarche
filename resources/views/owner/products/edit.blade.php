                ...
                <form method="post" action="{{ route('owner.products.update', ['product' => $product->id])}}" >
                    ...
                    <div class="-m-2">
                      ...
                      <div class="p-2 w-1/2 mx-auto">
                        ...
                        <div class="leading-7 text-sm text-gray-600" ">{{ $quantity }}
                        </div>
                        <div class="p-2 w-1/2 mx-auto">
                  ...
                  <form id="delete_{{$product->id}}" method="POST" action="{{ route('owner.products.destroy', ['product' => $product->id]) }}">
                    ...
                    <div class="md:px-4 py-3">
                        <a href="#" data-id="{{ $product->id }}" onclick="deletePost(this)" class="text-white bg-red-500 border-0 py-2 px-8 focus:outline-none hover:bg-red-600 rounded ">削除する</a>
                    </div>
                  </form> 
              </div>
          </div>
